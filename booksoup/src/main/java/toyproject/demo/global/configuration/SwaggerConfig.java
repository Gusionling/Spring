package toyproject.demo.global.configuration;
...
/**
 * packageName   : toyproject.demo.global.configuration
 * Author        : imhyeong-gyu
 * Data          : 2024. 12. 17.
 * Description   :
 */
...
public class SwaggerConfig {
    ...
    public OpenAPI openApi() {
        String description = "BookSoup API";
        ...
        return new OpenAPI()
                ...
                .externalDocs(new ExternalDocumentation().description("복습 API"));
    }
}
